        ...
        <div class="py-4">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    ...
                    <form action="{{ route('contas-receber.store') }}" method="POST" class="space-y-8">
                        @csrf
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <select name="tipo" id="tipo" required
                                        ...
                                        <option value="Salário" {{ old('tipo') == 'Salário' ? 'selected' : '' }}>
                                            <i class="fas fa-money-bill-wave"></i> Salário
                                        </option>
                                        <option value="Freelance" {{ old('tipo') == 'Freelance' ? 'selected' : '' }}>
                                            <i class="fas fa-laptop-code"></i> Freelance
                                        </option>
                                        <option value="Investimentos" {{ old('tipo') == 'Investimentos' ? 'selected' : '' }}>
                                            <i class="fas fa-chart-line"></i> Investimentos
                                        </option>
                                        <option value="Vendas" {{ old('tipo') == 'Vendas' ? 'selected' : '' }}>
