    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gradient items-center justify-center p-12">
            <div class="max-w-lg text-center text-white">
                ...
                <p class="text-lg opacity-90">Acompanhe seus empréstimos de forma simples e segura</p>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
            <div class="max-w-md w-full">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8">
                    <h2 class="text-2xl font-bold text-gray-900 mb-6">Acesso ao Cliente</h2>
                    <p class="text-gray-600 mb-8">Faça login para ver seus empréstimos</p>

                    <form action="{{ route('emprestimos.usuario.login') }}" method="POST" class="space-y-6">
                        @csrf
