        ...
        <div class="py-4">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    ...
                    <form action="{{ route('emprestimos.update', $emprestimo->id) }}" method="POST" class="space-y-8">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="nome" id="nome"
                                           value="{{ old('nome', $emprestimo->nome) }}"
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="valor" id="valor"
                                           value="{{ old('valor', $emprestimo->valor) }}"
                                           step="0.01"
                                           placeholder="0,00"
                                           required
                                           class="block w-full pl-12 pr-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="juros" id="juros"
                                           value="{{ old('juros', $emprestimo->juros) }}"
                                           step="0.01"
                                           placeholder="0,00"
                                           required
                                           class="block w-full pl-12 pr-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="valor_jurosdiarios" id="valor_jurosdiarios"
                                           value="{{ old('valor_jurosdiarios', $emprestimo->valor_jurosdiarios) }}"
                                           step="0.01"
                                           placeholder="0,00"
                                           required
                                           class="block w-full pl-12 pr-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200">
