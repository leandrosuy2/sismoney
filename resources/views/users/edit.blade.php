        ...
        <div class="py-4">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    ...
                    <form action="{{ route('users.update', $user->idUsuario) }}" method="POST" class="space-y-8">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">Mínimo 6 caracteres. Deixe em branco para manter a senha atual.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">
                                    Marque para dar acesso administrativo.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-md">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                ...
                                <div>
                                    <span class="font-medium text-gray-700">Tipo de Usuário:</span>
                                    <span class="text-gray-600">
                                        @if($user->isAdmin)
