        ...
        <div class="py-4">
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    ...
                    <form action="{{ route('contas-pagar.store') }}" method="POST" class="space-y-8">
                        @csrf
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <select name="tipo" id="tipo" required
                                        ...
                                        <option value="Aluguel" {{ old('tipo') == 'Aluguel' ? 'selected' : '' }}>
                                            <i class="fas fa-home"></i> Aluguel
                                        </option>
                                        <option value="Energia" {{ old('tipo') == 'Energia' ? 'selected' : '' }}>
                                            <i class="fas fa-bolt"></i> Energia
                                        </option>
                                        <option value="Água" {{ old('tipo') == 'Água' ? 'selected' : '' }}>
                                            <i class="fas fa-tint"></i> Água
                                        </option>
                                        <option value="Internet" {{ old('tipo') == 'Internet' ? 'selected' : '' }}>
                                            <i class="fas fa-wifi"></i> Internet
                                        </option>
                                        <option value="Telefone" {{ old('tipo') == 'Telefone' ? 'selected' : '' }}>
                                            <i class="fas fa-phone"></i> Telefone
                                        </option>
                                        <option value="Outros" {{ old('tipo') == 'Outros' ? 'selected' : '' }}>
                            ...
                            <div class="space-y-2 md:col-span-2">
                                ...
                                <div class="relative">
                                    ...
                                    <select name="status" id="status" required
                                        ...
                                        <option value="atrasado" {{ old('status') == 'atrasado' ? 'selected' : '' }}>
